...
export const translations = {
  uz: {
    ...
    searchAdmins: "Adminlarni qidirish",
    ...
    inventoryLoadError: "Ombor ma'lumotlari yuklanmadi",
     ...
     deleteDebtorConfirm: "{name} ni qarzdorlar ro'yxatidan o'chirmoqchimisiz?",
      ...
      duration6m: "6 oy",
      duration12m: "12 oy",
      duration6mDiscount: "6% chegirma",
      duration12mDiscount: "12% chegirma",
      durationPrice6m: "248 160 so'm",
      durationPricePro6m: "558 360 so'm",
      durationPrice12m: "464 640 so'm",
      durationPricePro12m: "1 045 440 so'm",
      perMonth: "oyiga",
      ...
      blockCodeSet: "Blok kod o'rnatildi",
      blockCodeChanged: "Blok kod o'zgartirildi",
      blockCodeRemoved: "Blok kod o'chirildi",
      blockCodeWrong: "Blok kod noto'g'ri",
      enter4DigitCode: "4 xonali raqam kiriting",
      codesDoNotMatch: "Kodlar bir xil emas",
      unlockFormDesc: "Mahsulot formasini ochish uchun himoya kodini kiriting",
      changeBlockCodeTitle: "Blok kodni o'zgartirish",
      setBlockCodeTitle: "Blok kod o'rnatish",
      enterNew4Digit: "Yangi 4 xonali raqam kiriting",
      protectCodeDesc: "Mahsulot formasini ochish uchun himoya kodi (4 xonali)",
      repeatCode: "Kodni takrorlang",
      setBlockCodeInSettings: "Avval Sozlamalarda blok kod o'rnating",
      blockCodeTitle: "Blok kod",
      blockCodeOn: "O'rnatilgan",
      blockCodeOff: "O'rnatilmagan",
      blockCodeHint: "Mahsulotni tahrirlab saqlashda himoya kodi so'raladi",
  ...
  ru: {
    ...
    deleteDebtorConfirm: "Удалить {name} из списка должников?",
      ...
      duration6m: "6 мес",
      duration12m: "12 мес",
      duration6mDiscount: "скидка 6%",
      duration12mDiscount: "скидка 12%",
      durationPrice6m: "186 120 сум",
      durationPricePro6m: "558 360 сум",
      durationPrice12m: "348 480 сум",
      durationPricePro12m: "1 045 440 сум",
      perMonth: "в месяц",
      ...
      blockCodeSet: "Блок-код установлен",
      blockCodeChanged: "Блок-код изменён",
      blockCodeRemoved: "Блок-код удалён",
      blockCodeWrong: "Неверный блок-код",
      enter4DigitCode: "Введите 4-значный код",
      codesDoNotMatch: "Коды не совпадают",
      unlockFormDesc: "Введите код защиты, чтобы открыть форму товара",
      changeBlockCodeTitle: "Изменить блок-код",
      setBlockCodeTitle: "Установить блок-код",
      enterNew4Digit: "Введите новый 4-значный код",
      protectCodeDesc: "Код защиты (4 цифры) для открытия формы товара",
      repeatCode: "Повторите код",
      setBlockCodeInSettings: "Сначала установите блок-код в Настройках",
      blockCodeTitle: "Блок-код",
      blockCodeOn: "Установлен",
      blockCodeOff: "Не установлен",
      blockCodeHint: "При сохранении изменений товара запрашивается код защиты",
