...
export const translations = {
  ...
  ru: {
    ...
    price_qty_warning: 'Неверные данные о цене или количестве приведут к путанице в будущих расчетах. Поэтому отрицательное количество, цена 0 и убыточные продажи автоматически блокируются.',
    edit_product_warning: 'Здесь находится реальный остаток товара. Если товар поступил или количество увеличилось, обновляйте здесь, страница склада также будет синхронизирована.',
    ...
    restockInfo: 'Здесь вы можете только увеличить количество товара. Введите количество поступившего товара, система автоматически обновит общий остаток.',
    result: 'Результат',
    buy: 'Закупочная',
    sell: 'Продажа',
    add: 'Добавить',
    ...
    inventoryInfo: 'На складе вносится только фактический остаток. Проданное количество рассчитывается автоматически. При поступлении товара увеличивайте остаток на странице продуктов.',
    readOnlyMode: 'Режим просмотра',
    startQtyAuto: 'Начальное количество автоматически. Его нельзя изменить на складе.',
    ...
    warning_qtyAdjust: 'На складе можно только уменьшать остаток. При поступлении товара увеличивайте остаток на странице продуктов.',
    loadingInventory: 'Данные об остатках загружаются...',
    notAvailableYet: 'Еще не доступно',
    end: 'Конец',
    ...
    noSalesPeriod: 'В этом периоде еще не было продаж, поэтому значения показаны как 0.',
    ...
    adminInfo: 'Новый админ может работать только с продуктами и складом. Список админов видит только супер-админ.',
